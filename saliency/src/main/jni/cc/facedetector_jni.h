...
JNIEXPORT JNICALL jint TNN_FACE_DETECTOR(predictFromStream)(JNIEnv *env, jobject thiz, jbyteArray yuv420sp, jint width, jint height, jint rotate, jobject retMat);
#ifdef __cplusplus
}
#endif
